...
def parse_args():
    ...
    parser.add_argument('--prefix', default= 'D:\PycharmProjects\LearningProject\insightface_pytorch_datasets_make\dataset_file\lst\\', help = 'prefix of input/output lst and rec files.')
    # parser.add_argument('--prefix', default='/home/mayichao/InsightFace_Pytorch/data/facebank/casia_lst',help='prefix of input/output lst and rec files.')
    parser.add_argument('--root', default='D:\PycharmProjects\LearningProject\insightface_pytorch_datasets_make\dataset_file\EAR_train', help='path to folder containing images.')
